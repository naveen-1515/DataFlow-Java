...
public class CsvToBQPipeline {
     ...
     private static String HEADERS = "ID,Code,Value";
    ...
    public static void main(String[] args) throws Throwable {
         ...
         String sourceFilePath = "gs://cst-i094/samplecsv.csv";
         String tempLocationPath = "gs://cst-i094/temp";
         boolean isStreaming = false;
         TableReference tableRef = new TableReference();
         // Replace this with your own GCP project id
         tableRef.setProjectId("bamboo-bulwark-319114");
         tableRef.setDatasetId("CST_I094_Sample_Dataset");
         tableRef.setTableId("samplecsv");
        PipelineOptions options = PipelineOptionsFactory.fromArgs(args).withValidation().create();
         // This is required for BigQuery
         options.setTempLocation(tempLocationPath);
         options.setJobName("csvtobq-java");
